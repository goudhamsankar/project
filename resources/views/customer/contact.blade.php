            ...
            <div class="contact-wrap d-flex align-items-center row">
                <div class="col-lg-6 sm-padding">
                    <div class="contact-info">
                        ...
                        <p>Welcome to our salon's contact page! We're thrilled to connect with you. Whether you're seeking an appointment, have questions about our services, or simply want to share feedback, we're here to assist you. Our dedicated team is committed to providing exceptional customer service and ensuring your experience with us is nothing short of extraordinary. Feel free to reach out to us via phone, email, or by filling out the form below. We'll make sure to respond promptly and address any inquiries you may have. Thank you for considering our salon, and we look forward to hearing from you soon!.</p>
                        <h3> <br>INDIA, bangalore</h3>
                        <h4><span>Email:</span> salon@door@gmail.com <br> <span>Phone:</span> +91 9876543210 <br>
                            <span>Fax:</span> +91 9876543210</h4>
                    </div>
                </div>
                <div class="col-lg-6 sm-padding">
